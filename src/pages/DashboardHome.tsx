...
import { useNavigate } from "react-router-dom";
import { useAuth } from "../contexts/AuthContext";
import { ClipboardList } from "lucide-react"; // for the "View All" button icon
    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-3 gap-6 mb-8">
        {isTeacher ? (
          <>
            <StatCard title="Total Students" value="24" subtext="+2 new" />
            <StatCard title="Pending Reviews" value="14" subtext="8 urgent" />
            <StatCard title="Class Average" value="78%" subtext="+2.1%" />
          </>
        ) : (
          <>
...
// Inline helper components that were in your original file:
...
const TeacherDashboardContent: React.FC = () => (
  <div className="grid grid-cols-2 gap-6">
    {/* ...your AssignmentProgress cards and PendingReviewRow table... */}
  </div>
);
